        ...
        const normalDisplay =
            <div className={lobbyStyles.container}>
                ...
                <div className={lobbyStyles.tabPanel}>
                    ...
                    <div className={lobbyStyles.tabPanelFilter}><span><label><input defaultChecked={this.props.filterOnline} type="checkbox" onClick={this.filterOnline}/> Online only</label> </span></div>
                    {userDisplayList}
                </div>
